...
namespace Foxic.DataAccess.Migrations
{
    ...
    [Migration("20230902082809_CreateAllTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foxic.Core.Entities.AreaEntityController.Slider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foxic.Core.Entities.ProductDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foxic.Core.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Foxic.Core.Entities.Product", null)
                        .WithMany("Orders")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Foxic.Core.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Foxic.Core.Entities.ProductDetails", "Detail")
                        .WithMany()
